...
-- Source object: [ratings].[sp_legacy_bayrate_get_checkpoint_before_event].
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO

CREATE OR ALTER PROCEDURE [ratings].[sp_legacy_bayrate_get_checkpoint_before_event]
...
BEGIN
    ...
    (
        ...
        FROM [ratings].[legacy_bayrate_player_checkpoint] AS c
